    ...
    <View style={styles.container}>
      ...
      <View style={styles.contactContainer}>
        <View style={styles.singleElement}>
          <Image
            source={require('./images/Nikhil.png')}
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              Linking.openURL(
                'https://www.linkedin.com/in/nikhil-kumar-523978179/',
              );
            }}>
            <Image
              source={require('./images/Linkdin.png')}
          ...
          <TouchableOpacity
            style={{flexDirection: 'row', alignItems: 'center'}}
            onPress={() => {
              Linking.openURL('https://github.com/nikkr008');
            }}>
            <Image
        ...
        <View style={styles.singleElement}>
          <Image
            source={require('./images/Durga.png')}
            style={styles.img}></Image>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              Linking.openURL(
                'https://www.linkedin.com/in/durgaprasad-goud-katepally-281a42223/',
              );
            }}>
            <Image
              source={require('./images/Linkdin.png')}
          ...
          <TouchableOpacity
            style={{flexDirection: 'row', alignItems: 'center'}}
            onPress={() => {
              Linking.openURL('https://github.com/Prasad4521');
            }}>
            <Image
              source={require('./images/Github.png')}
              style={styles.logoimg}></Image>
