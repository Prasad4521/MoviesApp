    ...
    <View style={styles.container}>
      ...
      <Text>otherParam: {JSON.stringify(otherParam)}</Text> */}
        ...
        <Text style={styles.resttxt}>
          <Text style={{color: 'blue', fontWeight: 'bold'}}>Language: </Text>
        ...
        <Text style={styles.resttxt}>
          <Text style={{color: 'blue', fontWeight: 'bold'}}>Overview: </Text>
          {item.overview}
        </Text>
        <Text style={styles.resttxt}>
          <Text style={{color: 'blue', fontWeight: 'bold'}}>Popularity: </Text>
          {item.popularity}
        </Text>
      </View>
